...
under_threshold_times_df_CTCF.to_csv(f'/mnt/md1/jjusuf/looping_review/analysis_data/CTCF_loops_under_threshold_times_{THRESHOLD}nm.csv', index=False, float_format="%.2f")